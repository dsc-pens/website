...
import { getLink as link } from '../metadata/links'
        ...
        <div className='columns'>
          <div className='column'>
            ...
            <p>
              ...
              developing{' '}
              <ExtLink href={link('pwa')}>Progressive Web Apps</ExtLink>
              {' with '}
              <ExtLink href={link('firebase')}>Firebase</ExtLink>
              {' integration, AR/VR apps using '}
              <ExtLink href={link('unity-ar-vr')}>Unity</ExtLink>
              {', and even try the latest programming languages like '}
              <ExtLink href={link('flutter')}>Flutter</ExtLink>
              {' and '}
              <ExtLink href={link('kotlin')}>Kotlin</ExtLink>.
            </p>
          </div>
          <div className='column'>
            <h4 className='title is-4'>
            ...
            <p>
              ...
              <ExtLink href={link('dsc-gh')}>GitHub</ExtLink>, to step-by-step
              examples with source codes and images, no need to double-guess how
              stuff works.
            </p>
          </div>
        </div>
